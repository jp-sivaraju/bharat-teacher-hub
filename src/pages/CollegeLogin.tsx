      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center space-y-4">
          <div className="flex items-center justify-center mb-4">
            <Building className="w-12 h-12 text-soft-blue-600" />
          </div>
        ...
        <Card className="border-2 border-soft-blue-200 hover:border-soft-blue-300 transition-all duration-300 shadow-blue">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-slate-gray-600">Access your college dashboard and post job openings</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-center space-y-2">
                ...
                <Link to="/college-register" className="text-sm text-soft-blue-600 hover:text-soft-blue-700 hover:underline block">
