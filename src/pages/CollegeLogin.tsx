        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="modern-card">
            <CardHeader className="text-center">
              ...
              <CardDescription className="text-body-medium">Access your college dashboard and manage faculty</CardDescription>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  <Label htmlFor="institution-email" className="text-body-medium font-semibold">Email Address</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="institution-password" className="text-body-medium font-semibold">Password</Label>
                  <Input
                ...
                <div className="text-center space-y-3">
                  ...
                  <Link to="/college-register" className="text-sm text-purple-600 hover:text-purple-700 hover:underline block transition-colors duration-200">
