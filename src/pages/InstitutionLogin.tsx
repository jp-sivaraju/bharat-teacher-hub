...
export const InstitutionLogin = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log('Institution login attempted:', formData.email);
    toast({
      title: "Login Successful!",
      description: "Welcome back! Redirecting to your institution dashboard.",
    });
    setTimeout(() => {
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <Card className="border-2 hover:border-indigo-300 transition-all duration-300">
          <CardHeader className="text-center">
            ...
            <CardDescription>Access your coaching center or college dashboard</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-center space-y-2">
                ...
                <Link to="/institution-register" className="text-sm text-purple-600 hover:text-purple-700 hover:underline block">
