      ...
      <div className="p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-md mx-auto bg-card p-6 rounded-lg shadow-md border border-border">
            ...
            <h2 className="text-2xl font-bold text-center mb-2 text-foreground font-mono">School Login</h2>
            <p className="text-center text-muted-foreground mb-6 font-mono">Access your school profile and opportunities</p>
            <form>
              <div className="mb-4">
              ...
              <div className="text-center mt-2">
                <a href="" className="text-primary hover:underline text-sm font-mono">Don't have an account? Register here</a>
              </div>
            </form>
          </div>
        </div>
