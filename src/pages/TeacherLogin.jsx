      ...
      <div className="p-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="max-w-md mx-auto bg-white p-6 rounded-lg shadow-md border border-orange-200">
            ...
            <h2 className="text-2xl font-bold text-center mb-2">Teacher Login</h2>
            <p className="text-center text-orange-600 mb-6">Access your teaching profile and opportunities</p>
            <form>
              <div className="mb-4">
              ...
              <div className="text-center mt-2">
                <a href="/teacher-register" className="text-orange-600 hover:underline text-sm">Don't have an account? Register here</a>
              </div>
            </form>
          </div>
        </div>
