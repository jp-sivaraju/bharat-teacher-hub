...
export const TeacherLogin = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-orange-50 via-white to-blue-50 flex items-center justify-center p-6">
      <div className="max-w-md w-full space-y-8">
        ...
        <Card className="border-2 hover:border-orange-300 transition-all duration-300">
          <CardHeader className="text-center">
            ...
            <CardDescription>Access your teaching profile and opportunities</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-center space-y-2">
                ...
                <Link to="/teacher-register" className="text-sm text-blue-600 hover:text-blue-700 hover:underline block">
